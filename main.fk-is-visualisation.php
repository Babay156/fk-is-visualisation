...
class ItopSynchroDashboardMenus extends ModuleHandlerAPI
{
	...
	public static function OnMenuCreation()
	{
		...
		if (UserRights::IsAdministrator())
		{
			...
			new WebPageMenuNode('DataSourcesDashboard', utils::GetAbsoluteUrlAppRoot().'pages/exec.php?exec_module=fk-is-visualisation&exec_page=dashboard.php', $sParentMenuIndex, 25 /* fRank */);
		}
	}
}
